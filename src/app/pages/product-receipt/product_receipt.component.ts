...
@Component({
  templateUrl: 'product_receipt.component.html'
})
...
export class ProductReceiptComponent {
	...
	ngAfterViewInit(): void {
		this.getCount(10,0,null,null,null,null,null,null,null);
	}
	...
	resetData(){
		...
		this.getCount(10,0,this.createdBy,this.hpb,this.project,this.product,this.approval,this.approvalrole,null);
	}
