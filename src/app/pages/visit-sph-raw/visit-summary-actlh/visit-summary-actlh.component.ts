...
@Component({
    templateUrl: 'visit-summary-actlh.component.html'
  })
export class VisitSummaryAcTlhComponent{
    busy:any;
    ...
    searchData(){
        ...
        if(this.monthErr == false){
            this.busy = this.reportVisitApi.getVisitSummarySph(sphId, this.uiDdlPeriode, this.uiTxtDdlVisitIdeal).subscribe(
				data=>{
