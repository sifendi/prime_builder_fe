...
@Component({
    templateUrl: 'summary-region.component.html'
  })
export class SummaryRegionComponent{
    busy:any;
    ...
    searchData(){
        ...
        if(this.monthErr == false){
            ...
            this.busy = this.reportSummaryApi.getReportSummaryRegion(acId, fromDate, toDate).subscribe(
				data=>{
        ...
        if(this.monthErr == false){
            ...
            this.busy = this.reportSummaryApi.getReportSummaryRegion(acId, fromDate, toDate).subscribe(
				data=>{
					...
					this.exportExcelUtil.makeExcel(this.exportData,"hpbReportSummaryRegion");
				},
				err=>{},
				()=>{}
			)
