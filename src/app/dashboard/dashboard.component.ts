...
//import { DashboardApi }  from '../../shared/loopback_sdk';
...
export class DashboardComponent implements OnInit {
	...
	totalDataCtns:any={tse:0,bde:0,constructor:0,prelead:0,lead:0,site:0};
	userDetails:any;
	rolename:any;
	username:any;
	
	constructor(private _cookieService:CookieService,private router:Router,public sharS:ShareService, private loopAuth:LoopBackAuth, private uApi:App_usersApi) {
		//this.userDetails = this.loopAuth.getCurrentUserData();
		// this.username = this.userDetails.realm;
  ...
  ngOnInit(): void {
      ...
      // let getCurrUserData = this.sharS.getshareData('currUserData');
      //     this.busy=this.dashboardApi.getCounts(null,getCurrUserData['userAreaData']).subscribe((dashboardCtnData)=>{
      //     this.totalDataCtns=dashboardCtnData['total_counts'];
      //     },(error)=>{
